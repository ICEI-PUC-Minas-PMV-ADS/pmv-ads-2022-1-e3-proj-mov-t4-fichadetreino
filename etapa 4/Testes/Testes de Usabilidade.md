...
| **Caso de Teste** |**CT-01 - Fazer Login e CRUD usuário no sistema**| 
|---|----|
|Requisitos Associados | RNF-01 O sistema foi capaz de tratar exceções e se recuperar de falhas sem que haja perda de dados <br/> A tela deve ser visualizada com letras roxas e fundo branco, os botões abaixo dos campos para inserção de dados | 
...
|**Caso de Teste** |**CT-02 - CRUD ficha de treino**| 
|---|----|
...
|Passos |1) Acessar o aplicativo <br/> 2) Acessar a tela de login <br/> | 3) Realizar o login 4)Clicar no ícone de exercícios físicos 5) Clicar em "+" 6) Adicionar ficha de treino 7) Salvar
